      ...
      <div className="main-container-lacarte">
        ...
        >
          <Grid item xs={6} md={6} className="menu1">
            menú de la mer
            <p>
              SERVI SEULEMENT AU DÉJEÛNER - 55 € <br />- Thon germon en tartare
              , concombre et coriandre ou Sardine en beignet , tomate et menthe
              Lotte tiède aux herbes d’été ou palourdes à l’ail Gâteau au
              chocolat ou salade d’agrumes
            </p>
          </Grid>
        </Grid>
        <Grid
          ...
          <Grid item xs={12} md={8}>
            <div className="menu3">
              ...
              <p>
                ...
                <br />
                Friture d'Encornets nature 28€ Encornets poêlés à l'ail 28€ <br />
        ...
        <Grid
          ...
          alignItems="flex-end"
        >
          <Grid item xs={12} md={8} className="menu4">
            Les plats
            <p>
          ...
          <Grid item xs={12} md={4} className="menu5">
            Poissons grillés
            <p>
